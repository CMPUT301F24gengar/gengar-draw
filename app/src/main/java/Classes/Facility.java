 ...
 *     data:<ul> <li>name</li> <li>location</li> <li>description</li> <li>local instance of facility photo</li> <li>list of event ids</li></ul>
 *     methods include:<ul> <li>constructors</li> <li>getters</li> <li>setters</li></ul>
 *
